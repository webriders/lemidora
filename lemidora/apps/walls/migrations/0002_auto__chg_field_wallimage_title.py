...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WallImage.title'
        db.alter_column('walls_wallimage', 'title', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))

    def backwards(self, orm):

        # Changing field 'WallImage.title'
        db.alter_column('walls_wallimage', 'title', self.gf('django.db.models.fields.CharField')(default='untitled', max_length=256))
