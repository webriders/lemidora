...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WallImage.image_file'
        db.alter_column('walls_wallimage', 'image_file', self.gf('sorl.thumbnail.fields.ImageField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'WallImage.image_file'
        db.alter_column('walls_wallimage', 'image_file', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
    ...
    models = {
        ...
        'walls.wallimage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_file': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '1024'}),
